...
export const ContractPaperContent = ({
    id,
    scale = 1,
    currentDay,
    currentMonth,
            ...
            <Stack spacing={1}>
                ...
                <Box>
                    ...
                    <Stack direction="row" alignItems="flex-end" spacing={1} sx={{ mb: 1 }}>
                        ...
                        {signatureImage ? (
                            <Typography variant="body2" fontSize={16} fontFamily="Times New Roman" fontWeight="bold" sx={{ pb: 0.5, pl: 1 }}>{getValues('fullName').toUpperCase()}</Typography>
                        ) : (
                            <RHFTextField
                                name="fullName"
                                variant="standard"
                    ...
                    <Stack direction="row" spacing={2} sx={{ mb: 1 }}>
                        <Stack direction="row" alignItems="flex-end" spacing={1} sx={{ width: '40%' }}>
                            ...
                            {signatureImage ? (
                                <Typography variant="body2" fontSize={16} fontFamily="Times New Roman" fontWeight="bold" sx={{ pb: 0.5, pl: 1 }}>{getValues('birthYear')}</Typography>
                            ) : (
                                <RHFTextField
                                    name="birthYear"
                                    variant="standard"
                    ...
                    <Stack direction="row" alignItems="flex-end" spacing={1} sx={{ mb: 1 }}>
                        ...
                        {signatureImage ? (
                            <Typography variant="body2" fontSize={16} fontFamily="Times New Roman" fontWeight="bold" sx={{ pb: 0.5, pl: 1 }}>{getValues('cccd')}</Typography>
                        ) : (
                            <RHFTextField
                                name="cccd"
                                variant="standard"
                    ...
                    <Stack direction="row" alignItems="flex-end" spacing={1} sx={{ mb: 1 }}>
                        ...
                        {signatureImage ? (
                            <Typography variant="body2" fontSize={16} fontFamily="Times New Roman" fontWeight="bold" sx={{ pb: 0.5, pl: 1 }}>{getValues('address')}</Typography>
                        ) : (
